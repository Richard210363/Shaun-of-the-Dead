class Shaun_of_the_Dead_13(object):
...
wn = turtle.Screen()
wn.bgcolor("black")
wn.title("Shaun of the Dead v13")
wn.setup(700,700)
...
class Player(turtle.Turtle):
    ...
    def is_collision_with_enemy(self, other):
        a=self.xcor() - other.xcor()
        b = self.ycor() - other.ycor()
        distance = math.sqrt((a **2) + (b **2))
...
while True:
    #new removed line
    for enemy in enemies:
        if player.is_collision_with_enemy(enemy):
            print ("Shaun is DEAD!!")
    ...
    if player.is_collision_with_treasure(treasure):
        ...
        print ("Shaun got " + str(treasure.bullets) + " bullets")  #Question: What is going on here?
        #treasure.destroy()
    wn.update()
