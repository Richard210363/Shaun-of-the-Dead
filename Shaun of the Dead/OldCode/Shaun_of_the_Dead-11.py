...
wn = turtle.Screen()
wn.bgcolor("black")
wn.title("Shaun of the Dead v11")
wn.setup(700,700)
...
for enemy in enemies:
    enemy.move()  #Holiday: Why did I remove the timer part from this line; what difference did it make?
...
turtle.onkey(fire_bullet,'f')  #Holiday: We can't call fire_bullet if fire_bullet is below this line.  Why is this?
wn.tracer(0)
