class Shaun_of_the_Dead_16(object):
    """Control Module"""
...
wn = turtle.Screen()
wn.bgcolor("black")
wn.title("Shaun of the Dead v16")
wn.setup(700,700)
...
turtle.listen()
turtle.onkey(player.go_left(walls),"a")
turtle.onkey(player.go_right(walls),'d')
turtle.onkey(player.go_up(walls),'w')
turtle.onkey(player.go_down(walls),'s')
